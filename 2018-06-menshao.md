...
### **2.最终项目流程**
![登录界面]({{site.baseurl}}//TIM%E5%9B%BE%E7%89%8720190307120055.png)
测试用户为：焖烧饭  menshaofan（分别为用户名和密码）
![首页]({{site.baseurl}}//TIM%E5%9B%BE%E7%89%8720190307120418.png)
![下单]({{site.baseurl}}/TIM图片20190307120610.png)
![菜谱]({{site.baseurl}}/TIM图片20190307120655.png)
![购物车]({{site.baseurl}}/TIM图片20190307120746.png)
